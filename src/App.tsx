            ...
            <div className="space-y-4 animate-fadeIn text-xs">
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  {[
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center justify-center p-2 rounded-lg border transition-all duration-150 ${activeWallet === w.key
              ...
              <div className="bg-slate-900/60 p-2 border border-slate-800 rounded-xl flex items-center justify-between gap-2.5">
                ...
                <div className="flex bg-slate-950 border border-slate-800 rounded-lg p-0.5">
                  <button
                    onClick={() => setMode('USD')}
                    className={`text-[9px] font-bold py-1 px-2.5 rounded-md transition font-mono ${mode === 'USD' ? 'bg-blue-600 text-white font-extrabold shadow' : 'text-slate-400 hover:text-slate-200'
                      }`}
                  >
                    USD
                  </button>
                  <button
                    onClick={() => setMode('BS')}
                    className={`text-[9px] font-bold py-1 px-2.5 rounded-md transition font-mono ${mode === 'BS' ? 'bg-blue-600 text-white font-extrabold shadow' : 'text-slate-400 hover:text-slate-200'
                      }`}
                  >
                    VES
                  </button>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`flex flex-col text-left p-3 rounded-xl border transition duration-150 ${activeKey === rateItem.key
                          ...
                          <div key={t.id} className="bg-[#090d16] border border-slate-850 rounded-xl p-3 flex flex-col gap-2 relative group hover:border-slate-800 transition">
                            <div className="flex justify-between items-center text-[9px] text-slate-500 border-b border-slate-850/60 pb-1 font-mono">
                              <span className="flex items-center gap-1.5">
                                ...
                                <span className={`px-1 rounded-[3px] text-[8px] font-bold ${t.wallet === 'ticket'
                            ...
                            <div className="flex justify-between items-start">
                              <div>
                                ...
                                <div className="flex flex-wrap items-center gap-1.5 mt-1">
                                  <span className={`inline-block px-1.5 py-0.5 rounded text-[8px] font-black uppercase ${isIncome ? 'bg-emerald-950/50 text-emerald-400' : 'bg-red-950/50 text-red-400'
                                    }`}>
                              ...
                              <div className="text-right">
                                <span className={`block font-mono font-bold text-xs ${isIncome ? 'text-emerald-400' : 'text-red-400'
                                  }`}>
        ...
        {/* --- SMARTPHONE FLOATING ACTION BUTTON --- */}
          ...
          <nav className="absolute bottom-0 inset-x-0 bg-[#090d16] border-t border-slate-800/80 px-4 py-2 flex items-center justify-around z-30 shrink-0 select-none">
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 transition ${activeTab === 'resumen' ? 'text-blue-500' : 'text-slate-500 hover:text-slate-350'
                }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 transition ${activeTab === 'movimientos' ? 'text-blue-500' : 'text-slate-500 hover:text-slate-350'
                }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 transition ${activeTab === 'analista' ? 'text-blue-500' : 'text-slate-500 hover:text-slate-350'
                }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 transition ${activeTab === 'conversor' ? 'text-blue-500' : 'text-slate-500 hover:text-slate-350'
                }`}
            >
